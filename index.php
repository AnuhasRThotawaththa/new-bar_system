...
<head>
  ...
  <title>Sip & Sit – Premium Liquor Experience</title>
  <meta name="description" content="Order top-quality liquors online, reserve tables, or get delivery. Curated wines, beers & whiskeys served responsibly." />
...
<section class="relative h-screen flex items-center justify-center overflow-hidden">
  <!-- Video background - Now using local file -->
  <div class="absolute inset-0 z-0">
    <video autoplay muted loop playsinline class="w-full h-full object-cover">
      <!-- Replace "assets/videos/your-video.mp4" with your actual video path -->
      <source src="video/video1.mp4" type="video/mp4">
      <!-- Fallback image if video doesn't load -->
      <img src="assets/images/fallback-bg.jpg" alt="Background" class="w-full h-full object-cover">
    </video>
  ...
  <div class="relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
    <div class="mb-8">
      <!-- Your logo/animation can go here -->
    </div>
    <h1 class="text-5xl md:text-7xl font-bold mb-6 hero-text">Sip & Sit</h1>
    <p class="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">Discover the finest selection of premium liquors, craft beers, and exquisite wines delivered to your doorstep or enjoyed at our cozy venues.</p>
    <div class="flex flex-col sm:flex-row justify-center gap-4">
      <a href="login.php" class="px-8 py-4 bg-yellow-400 text-gray-900 font-bold rounded-full hover:bg-yellow-300 transition-all duration-300 transform hover:scale-105 shadow-lg">
        Explore Menu
      </a>
    </div>
  </div>
...
<!-- Features Section -->
<section id="features" class="py-20 bg-gradient-to-b from-gray-900 to-gray-950">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16">
      <span class="text-yellow-400 font-medium uppercase tracking-wider">Why Choose Us</span>
      <h2 class="text-4xl md:text-5xl font-bold mt-4">An Unparalleled Experience</h2>
    </div>
    
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
      <div class="glass p-8 rounded-xl hover:shadow-lg transition-all duration-500 transform hover:-translate-y-2">
        <div class="w-16 h-16 bg-yellow-400/10 rounded-lg flex items-center justify-center mb-6">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
          </svg>
        </div>
        <h3 class="text-xl font-bold mb-3">Premium Selection</h3>
        <p class="text-gray-400">Curated by our master sommeliers and spirit experts to bring you only the finest quality beverages.</p>
      </div>
      ...
      <div class="glass p-8 rounded-xl hover:shadow-lg transition-all duration-500 transform hover:-translate-y-2">
        ...
        <p class="text-gray-400">Get your favorite drinks delivered in under 60 minutes with our premium delivery service.</p>
      </div>
      ...
      <div class="glass p-8 rounded-xl hover:shadow-lg transition-all duration-500 transform hover:-translate-y-2">
        ...
        <h3 class="text-xl font-bold mb-3">Exclusive Venues</h3>
        <p class="text-gray-400">Experience our handpicked venues with perfect ambiance for every occasion.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="py-20 bg-gray-950">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16">
      <span class="text-yellow-400 font-medium uppercase tracking-wider">Our Collections</span>
      <h2 class="text-4xl md:text-5xl font-bold mt-4">Explore Premium Selections</h2>
    </div>
    
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <!-- Collection 1 -->
      <div class="relative group overflow-hidden rounded-xl h-96">
        <img src="https://images.unsplash.com/photo-1551024506-0bccd828d307?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Whiskey Collection" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-6">
          <h3 class="text-2xl font-bold text-white mb-2">Rare Whiskeys</h3>
          <p class="text-gray-300 mb-4">Aged to perfection from the finest distilleries worldwide.</p>
          <a href="#" class="text-yellow-400 font-medium flex items-center group-hover:underline">
            Explore
      ...
      <!-- Collection 2 -->
      <div class="relative group overflow-hidden rounded-xl h-96">
        <img src="https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Wine Collection" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-6">
          <h3 class="text-2xl font-bold text-white mb-2">Fine Wines</h3>
          <p class="text-gray-300 mb-4">Curated selection from renowned vineyards across the globe.</p>
          <a href="#" class="text-yellow-400 font-medium flex items-center group-hover:underline">
            Explore
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
      ...
      <!-- Collection 3 -->
      <div class="relative group overflow-hidden rounded-xl h-96">
        <img src="https://images.unsplash.com/photo-1600788886242-5c96aabe3757?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Craft Beer Collection" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-6">
          <h3 class="text-2xl font-bold text-white mb-2">Craft Beers</h3>
          <p class="text-gray-300 mb-4">Artisanal brews from passionate local and international breweries.</p>
          <a href="#" class="text-yellow-400 font-medium flex items-center group-hover:underline">
            Explore
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
...
<!-- Reservation CTA -->
<section class="py-20 bg-gradient-to-r from-gray-900 to-gray-950 relative overflow-hidden">
  <div class="absolute inset-0 z-0">
    <img src="https://images.unsplash.com/photo-1514933651103-005eec06c04b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80" alt="Bar" class="w-full h-full object-cover opacity-20">
  </div>
    ...
    <div class="glass rounded-2xl p-8 md:p-12">
      <div class="md:flex items-center justify-between">
        <div class="md:w-1/2 mb-8 md:mb-0">
          <h2 class="text-3xl md:text-4xl font-bold mb-4">Book Your Perfect Evening</h2>
          <p class="text-gray-300 mb-6">Reserve a table at one of our exclusive venues and experience premium service in an ambiance crafted for memorable moments.</p>
          <ul class="space-y-3">
            <li class="flex items-center">
              ...
              <span class="text-gray-300">Personalized service</span>
            </li>
            <li class="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-400 mr-2" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
              </svg>
              <span class="text-gray-300">Exclusive lounge areas</span>
            </li>
            <li class="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-400 mr-2" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
              </svg>
              <span class="text-gray-300">Live music on weekends</span>
            </li>
          </ul>
        </div>
        <div class="md:w-1/2 md:pl-10">
          <form class="space-y-4">
            <div>
              ...
              <input type="date" id="date" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-yellow-400">
            </div>
            <div>
              <label for="time" class="block text-gray-300 mb-2">Time</label>
              <select id="time" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-yellow-400">
            ...
            <div>
              ...
              <select id="guests" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-yellow-400">
            ...
            <button type="submit" class="w-full bg-yellow-400 text-gray-900 py-3 rounded-lg font-bold hover:bg-yellow-300 transition duration-300">
              Check Availability
            </button>
          </form>
        </div>
...
<section class="py-20 bg-gray-950">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16">
      <span class="text-yellow-400 font-medium uppercase tracking-wider">Testimonials</span>
      <h2 class="text-4xl md:text-5xl font-bold mt-4">What Our Guests Say</h2>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="glass p-8 rounded-xl">
        ...
        <p class="text-gray-300 italic">"The whiskey selection at Sip & Sit is unparalleled. The staff's knowledge helped me discover new favorites I wouldn't have tried otherwise. The ambiance is perfect for both business meetings and casual nights out."</p>
      </div>
      ...
      <div class="glass p-8 rounded-xl">
        ...
        <p class="text-gray-300 italic">"I ordered a bottle of wine for a special occasion and was impressed by the fast delivery and careful packaging. The sommelier's note with pairing suggestions was a thoughtful touch that made our dinner extra special."</p>
      </div>
    </div>
    ...
    <div class="mt-12 flex justify-center">
      <div class="inline-flex space-x-2">
        ...
        <button class="w-3 h-3 rounded-full bg-gray-700"></button>
        <button class="w-3 h-3 rounded-full bg-gray-700"></button>
      </div>
    </div>
  </div>
...
<section class="py-12 bg-gray-950">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-12">
      <h2 class="text-3xl md:text-4xl font-bold mb-4">Follow Us <span class="text-yellow-400">@sipandsit</span></h2>
      <p class="text-gray-400 max-w-2xl mx-auto">Join our community of spirit enthusiasts and see what's happening at our venues.</p>
    </div>
    
    <div class="grid grid-cols-2 md:grid-cols-4 gap-1">
      <a href="#" class="group relative overflow-hidden rounded-lg aspect-square">
        <img src="https://images.unsplash.com/photo-1551024506-0bccd828d307?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" alt="Instagram post" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
      ...
      <a href="#" class="group relative overflow-hidden rounded-lg aspect-square">
        <img src="https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" alt="Instagram post" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
        <div class="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
          </svg>
      ...
      <a href="#" class="group relative overflow-hidden rounded-lg aspect-square">
        <img src="https://images.unsplash.com/photo-1600788886242-5c96aabe3757?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" alt="Instagram post" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
        <div class="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
          </svg>
      ...
      <a href="#" class="group relative overflow-hidden rounded-lg aspect-square">
        <img src="https://images.unsplash.com/photo-1514933651103-005eec06c04b?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" alt="Instagram post" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
        <div class="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
          </svg>
    ...
    <div class="text-center mt-12">
      <a href="#" class="inline-flex items-center px-6 py-3 border border-yellow-400 text-yellow-400 rounded-full font-medium hover:bg-yellow-400/10 transition duration-300">
...
<script>
  ...
  setInterval(() => {
    ...
    heroText.style.animation = 'shine 3s linear infinite';
  }, 3000);

  // Collection hover effect
  const collections = document.querySelectorAll('.relative.group');
  collections.forEach(collection => {
    const img = collection.querySelector('img');
    collection.addEventListener('mousemove', (e) => {
      const x = e.offsetX / collection.offsetWidth - 0.5;
      const y = e.offsetY / collection.offsetHeight - 0.5;
      img.style.transform = `scale(1.1) rotateX(${y * 10}deg) rotateY(${x * 10}deg)`;
    });
    collection.addEventListener('mouseleave', () => {
      img.style.transform = 'scale(1.1) rotateX(0) rotateY(0)';
    });
  });
  ...
  const testimonials = document.querySelectorAll('#testimonialSlides blockquote');
  ...
  document.querySelectorAll('.testimonial-nav button').forEach((button, index) => {
